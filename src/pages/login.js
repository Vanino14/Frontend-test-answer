...
return (
  ...
  <div className='bg-colorOne w-full h-[60vh] relative bg-[#e8f1fa] -z-10'>
...
<img src="./doctor.png" width={"500px"} alt="bg-login"/>
<hr className="text-slate-800"/>
</div>
                <div className='absolute w-full -top-64 left-96 -z-10'>
                ...
                <div className='absolute w-full -top-40 left-[40rem] -z-10 '>
                    <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                        <path fill="#CEF2F7" d="M11.8,-9.7C15.2,6.6,17.8,17.3,13.9,20.4C10,23.6,-0.4,19.2,-13,11.6C-25.6,3.9,-40.4,-7,-38.6,-21.2C-36.8,-35.3,-18.4,-52.6,-7.1,-50.3C4.2,-48,8.4,-26,11.8,-9.7Z" transform="translate(100 100)" />
                    </svg>
                </div>
            ...
            <div className='bg-colorTwo w-full h-[40vh] text-center relative bg-[#b5dbff]' >
